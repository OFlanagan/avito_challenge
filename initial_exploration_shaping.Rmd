...
df <- df %>% 
  ...
  city = city %>% factor() %>%  fct_lump(),
  parent_category_name = parent_category_name %>% factor(),
  category_name = category_name %>%  factor(), #potentially lump,
  param_1 = param_1 %>% factor() %>% fct_lump(),
  param_2 = param_2 %>% factor() %>% fct_lump(),
  param_3 = param_3 %>% factor() %>% fct_lump(),
  title = title %>% factor() %>% fct_lump(),
  description = description %>% factor() %>% fct_lump(),
